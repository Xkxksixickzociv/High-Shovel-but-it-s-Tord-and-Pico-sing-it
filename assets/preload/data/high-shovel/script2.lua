...
function flag()
  for i = 0,7 do
    ...
    setPropertyFromGroup('strumLineNotes', i, 'x', x[i] + 0 * math.cos(a + i*0.80))
  end
end
...
function onSongStart()
  ...
  for i = 0,7 do
    noteTweenX(i .. 'xpos', i, x[i] + 30 * math.cos(a + i*0.40), 1, 'circInOut')
    noteTweenY(i .. 'ypos', i, y[i] + 30 * math.cos(i/1.1 + a), 1, 'circInOut')
  end
end
